...
const Greeting = () => {
  ...
  const stats = [
    ...
    },
    {
      number: '50+',
      label: '周训练',
      icon: <IoMdTimer className="text-2xl" />,
    },
    {
      number: '15+',
      label: '赛事参与',
      icon: <GiPodium className="text-2xl" />,
    },
    {
      number: '1',
      label: '年历史',
      ...
      <div className="max-w-6xl mx-auto mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            ...
            >
              <div
                className={`w-16 h-16 bg-gradient-to-r rounded-full flex items-center justify-center mb-4 mx-auto`}
              >
                {feature.icon}
              </div>
